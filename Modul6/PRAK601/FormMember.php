        ...
        <div class="row">
            <form action="" method="post">
                <h1 style="text-align: center;" class="mt-2">Tambah Data Member</h1>
                    ...
                    <input type="password" name="password" id="password" class="form-control mb-3" value="<?php if (isset($_GET['id_member'])) echo $result[0]["password"] ?>" required>
                    ...
                    <?php
                        if (isset($_POST['update'])) {
                            ...
                            updatemember($_GET['id_member'],$_POST['nama_member'], $_POST['nomor_member'], md5($_POST['password']), $_POST['alamat'], $tgl_daftar, $_POST['tgl_terakhir_bayar']);
                        }
                        if (isset($_POST['tambah'])) {
                            $tgl_daftar = date_create($_POST['tgl_daftar']);
                            $tgl_daftar = date_format($tgl_daftar,"Y-m-d H:i:s");
                            print_r($_POST);
                            insertDataMember( $_POST['nama_member'], $_POST['nomor_member'], md5($_POST['password']), $_POST['alamat'], $tgl_daftar, $_POST['tgl_terakhir_bayar']);
                        }
                    ?>
                </div>
            </div> 
